...
def bob():
    ...
    if says==u"학생식당":
        response_data = js.returnjsonChoiceday()
        ...
        response_data = js.returnMenujson(findRes(user_key),ChoiceWeek)
        ...
        response_data = js.jsonChoiceRes

    elif says==u"식당 이용 가능 시간":
        response_data = js.jsonChoiceAvailableTime

    elif says==u"학생식당 시간":
        response_data = js.returnAvaliableTime(StudentTime)

    elif says == u"기숙사 시간":
        response_data = js.returnAvaliableTime(DomitoryTime)

    elif says == u"교직원 시간":
        response_data = js.returnAvaliableTime(ProfessTime)
